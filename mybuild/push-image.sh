...
IMAGE_NAME="${INFO_SSR_IMAGE:-info-web-frontend}"
IMAGE_TAG="${INFO_SSR_TAG:-1.0.0}"
IMAGE_REGISTRY="$(resolve_harbor_registry_for_push "${INFO_SSR_IMAGE_REGISTRY:-harbor.sunmoonai.com}")"
IMAGE_PROJECT="${INFO_SSR_IMAGE_PROJECT:-app-images}"
